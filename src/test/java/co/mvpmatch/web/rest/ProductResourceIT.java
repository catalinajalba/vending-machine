...
class ProductResourceIT {
    ...
    public static Product createUpdatedEntity(EntityManager em) {
        Product product = new Product().name(UPDATED_NAME).amountAvailable(UPDATED_AMOUNT_AVAILABLE).cost(UPDATED_COST);
        return product;
    }
    ...
    void createProduct() throws Exception {
        ...
        assertThat(testProduct.getAmountAvailable()).isEqualTo(DEFAULT_AMOUNT_AVAILABLE);
    ...
    void checkAmountAvailableIsRequired() throws Exception {
        int databaseSizeBeforeTest = productRepository.findAll().size();
        // set the field null
        product.setAmountAvailable(null);
    ...
    void putNewProduct() throws Exception {
        ...
        updatedProduct.name(UPDATED_NAME).amountAvailable(UPDATED_AMOUNT_AVAILABLE).cost(UPDATED_COST);
        ...
        assertThat(testProduct.getAmountAvailable()).isEqualTo(UPDATED_AMOUNT_AVAILABLE);
    ...
    void fullUpdateProductWithPatch() throws Exception {
        ...
        partialUpdatedProduct.name(UPDATED_NAME).amountAvailable(UPDATED_AMOUNT_AVAILABLE).cost(UPDATED_COST);
